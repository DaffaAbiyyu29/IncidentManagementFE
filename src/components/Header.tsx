      ...
      >
        <div className="flex gap-1 lg:hidden items-center -ml-1">
          ...
          <div className="flex items-center">
            ...
            >
              <i className="ki-solid ki-burger-menu-2"></i>
            </button>
          </div>
        </div>
                ...
                >
                  <div className="menu-link text-sm text-gray-700 font-medium menu-link-hover:text-primary menu-item-active:text-gray-900 menu-item-show:text-primary menu-item-here:text-gray-900 menu-item-active:font-semibold menu-item-here:font-semibold">
                    ...
                    <span className="menu-arrow flex lg:hidden">
                      <i className="ki-solid ki-plus text-2xs menu-item-show:hidden"></i>
                      <i className="ki-solid ki-minus text-2xs hidden menu-item-show:inline-flex"></i>
                    </span>
                  </div>
                          ...
                          <div className="grid lg:grid-cols-2 lg:gap-5">
                            <div className="flex flex-col">
                              <div className="menu-item">
                                ...
                                >
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-badge"></i>
                                  </span>
                              ...
                              <div className="menu-item">
                                ...
                                >
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-coffee"></i>
                                  </span>
                                  <span className="menu-title grow-0">
                                    Creator
                                  </span>
                              ...
                              <div className="menu-item">
                                ...
                                >
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-abstract-41"></i>
                                  </span>
                                  <span className="menu-title grow-0">
                                    Company
                                  </span>
                              ...
                              <div className="menu-item">
                                ...
                                >
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-bitcoin"></i>
                                  </span>
                              ...
                              <div className="menu-item">
                                ...
                                >
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-message-text"></i>
                                  </span>
                                  <span className="menu-title grow-0">
                                    Blogger
                                  </span>
                              ...
                              <div className="menu-item">
                                ...
                                >
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-devices"></i>
                                  </span>
                              ...
                              <div className="menu-item">
                                ...
                                >
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-ghost"></i>
                                  </span>
                                  <span className="menu-title grow-0">
                                    Gamer
                                  </span>
                            ...
                            <div>
                              <div className="menu-item">
                                ...
                                >
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-book"></i>
                                  </span>
                                  <span className="menu-title grow-0">
                                    Feeds
                                  </span>
                              ...
                              <div className="menu-item">
                                ...
                                >
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-files"></i>
                                  </span>
                                  <span className="menu-title grow-0">
                                    Plain
                                  </span>
                              ...
                              <div className="menu-item">
                                ...
                                >
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-mouse-square"></i>
                                  </span>
                                  <span className="menu-title grow-0">
                                    Modal
                                  </span>
                              ...
                              <div className="menu-item">
                                <a className="menu-link" href="#" tabIndex={0}>
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-financial-schedule"></i>
                                  </span>
                                  <span className="menu-title grow-0">
                                    Freelancer
                                  </span>
                              ...
                              <div className="menu-item">
                                <a className="menu-link" href="#" tabIndex={0}>
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-technology-4"></i>
                                  </span>
                                  <span className="menu-title grow-0">
                                    Developer
                                  </span>
                              ...
                              <div className="menu-item">
                                <a className="menu-link" href="#" tabIndex={0}>
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-users"></i>
                                  </span>
                                  <span className="menu-title grow-0">
                                    Team
                                  </span>
                              ...
                              <div className="menu-item">
                                <a className="menu-link" href="#" tabIndex={0}>
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-calendar-tick"></i>
                                  </span>
                                  <span className="menu-title grow-0">
                                    Events
                                  </span>
                          ...
                          <div className="grid lg:grid-cols-2 lg:gap-5">
                            <div className="flex flex-col">
                              <div className="menu-item">
                                ...
                                >
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-element-6"></i>
                                  </span>
                                  <span className="menu-title grow-0">
                                    Projects - 3 Columns
                                  </span>
                              ...
                              <div className="menu-item">
                                ...
                                >
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-element-4"></i>
                                  </span>
                                  <span className="menu-title grow-0">
                                    Projects - 2 Columns
                                  </span>
                              ...
                              <div className="menu-item">
                                ...
                                >
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-office-bag"></i>
                                  </span>
                                  <span className="menu-title grow-0">
                                    Works
                                  </span>
                              ...
                              <div className="menu-item">
                                ...
                                >
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-icon"></i>
                                  </span>
                                  <span className="menu-title grow-0">
                                    Network
                                  </span>
                              ...
                              <div className="menu-item">
                                ...
                                >
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-chart-line-up-2"></i>
                                  </span>
                                  <span className="menu-title grow-0">
                                    Activity
                                  </span>
                              ...
                              <div className="menu-item">
                                ...
                                >
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-element-11"></i>
                                  </span>
                                  <span className="menu-title grow-0">
                                    Campaigns - Card
                                  </span>
                            ...
                            <div>
                              <div className="menu-item">
                                ...
                                >
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-kanban"></i>
                                  </span>
                                  <span className="menu-title grow-0">
                                    Campaigns - List
                                  </span>
                              ...
                              <div className="menu-item">
                                ...
                                >
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-file-sheet"></i>
                                  </span>
                                  <span className="menu-title grow-0">
                                    Empty Page
                                  </span>
                              ...
                              <div className="menu-item">
                                <a className="menu-link" href="#" tabIndex={0}>
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-document"></i>
                                  </span>
                                  <span className="menu-title grow-0">
                                    Documents
                                  </span>
                              ...
                              <div className="menu-item">
                                <a className="menu-link" href="#" tabIndex={0}>
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-award"></i>
                                  </span>
                                  <span className="menu-title grow-0">
                                    Badges
                                  </span>
                              ...
                              <div className="menu-item">
                                <a className="menu-link" href="#" tabIndex={0}>
                                  <span className="menu-icon">
                                    <i className="ki-solid ki-gift"></i>
                                  </span>
                                  <span className="menu-title grow-0">
                                    Awards
                                  </span>
                    ...
                    <div className="lg:w-[250px] mt-2 lg:mt-0 lg:border-r lg:border-r-gray-200 rounded-xl lg:rounded-l-xl lg:rounded-r-none shrink-0 px-3 py-4 lg:p-7.5 bg-light-active dark:bg-coal-500 dark:lg:border-r-coal-100">
                      ...
                      <div className="menu menu-default menu-fit flex-col">
                        <div className="menu-item">
                          ...
                          >
                            <span className="menu-icon">
                              <i className="ki-solid ki-technology-2"></i>
                            </span>
                            <span className="menu-title grow-0">
                              Integrations
                            </span>
                        ...
                        <div className="menu-item">
                          ...
                          >
                            <span className="menu-icon">
                              <i className="ki-solid ki-notification-1"></i>
                            </span>
                            <span className="menu-title grow-0">
                              Notifications
                            </span>
                        ...
                        <div className="menu-item">
                          ...
                          >
                            <span className="menu-icon">
                              <i className="ki-solid ki-user-tick"></i>
                            </span>
                            <span className="menu-title grow-0">
                              Invite a Friend
                            </span>
                        ...
                        <div className="menu-item">
                          ...
                          >
                            <span className="menu-icon">
                              <i className="ki-solid ki-support"></i>
                            </span>
                        ...
                        <div className="menu-item">
                          ...
                          >
                            <span className="menu-icon">
                              <i className="ki-solid ki-verify"></i>
                            </span>
                        ...
                        <div className="menu-item">
                          ...
                          >
                            <span className="menu-icon">
                              <i className="ki-solid ki-euro"></i>
                            </span>
                      ...
                      <div className="flex flex-col gap-5 lg:w-[250px] mt-2 lg:mt-0 lg:border-r lg:border-r-gray-200 rounded-xl lg:rounded-none lg:rounded-tl-xl shrink-0 px-3 py-4 lg:p-7.5 bg-light-active dark:bg-coal-500 dark:lg:border-r-coal-100">
                        ...
                        <div className="menu menu-default menu-fit flex-col">
                          <div className="menu-item">
                            ...
                            >
                              <span className="menu-icon">
                                <i className="ki-solid ki-flag"></i>
                              </span>
                              <span className="menu-title grow-0">
                                Get Started
                              </span>
                          ...
                          <div className="menu-item">
                            ...
                            >
                              <span className="menu-icon">
                                <i className="ki-solid ki-heart"></i>
                              </span>
                              <span className="menu-title grow-0">
                                Donators
                              </span>
                          ...
                          <div className="menu-item">
                            ...
                            >
                              <span className="menu-icon">
                                <i className="ki-solid ki-abstract-21"></i>
                              </span>
                      ...
                      <div className="lg:w-[250px] mb-4 lg:mb-0 lg:border-l lg:border-l-gray-200 rounded-xl lg:rounded-r-xl lg:rounded-l-none shrink-0 px-3 py-4 lg:p-7.5 bg-light-active dark:bg-coal-500 dark:lg:border-l-coal-100">
                        ...
                        <div className="menu menu-default menu-fit flex-col">
                          <div className="menu-item">
                            ...
                            >
                              <span className="menu-icon">
                                <i className="ki-solid ki-like-2"></i>
                              </span>
                              <span className="menu-title grow-0">
                                Welcome Message
                              </span>
                          ...
                          <div className="menu-item">
                            ...
                            >
                              <span className="menu-icon">
                                <i className="ki-solid ki-shield-cross"></i>
                              </span>
                              <span className="menu-title grow-0">
                                Account Deactivated
                              </span>
                          ...
                          <div className="menu-item">
                            ...
                            >
                              <span className="menu-icon">
                                <i className="ki-solid ki-message-question"></i>
                              </span>
                              <span className="menu-title grow-0">
                                Error 404
                              </span>
                          ...
                          <div className="menu-item">
                            ...
                            >
                              <span className="menu-icon">
                                <i className="ki-solid ki-information"></i>
                              </span>
                              <span className="menu-title grow-0">
                                Error 500
                              </span>
                ...
                >
                  ...
                  <div className="menu-dropdown menu-default py-2.5 w-full max-w-[220px]">
                    ...
                    >
                      <div className="menu-link">
                        ...
                        <span className="menu-arrow">
                          <i className="ki-solid ki-right text-3xs"></i>
                        </span>
                      </div>
                      <div className="menu-dropdown menu-default w-full max-w-[175px] lg:max-w-[220px]">
                        <div className="menu-item">
                          ...
                          >
                            <span className="menu-icon">
                              <i className="ki-solid ki-questionnaire-tablet"></i>
                            </span>
                            <span className="menu-title grow-0">
                              All Questions
                            </span>
                        ...
                        <div className="menu-item">
                          ...
                          >
                            <span className="menu-icon">
                              <i className="ki-solid ki-star"></i>
                            </span>
                            <span className="menu-title grow-0">
                              Popular Questions
                            </span>
                    ...
                    <div className="menu-item">
                      ...
                      >
                        <span className="menu-icon">
                          <i className="ki-solid ki-subtitle"></i>
                        </span>
                        ...
                        >
                          <i className="ki-solid ki-information-2 text-gray-500 text-md"></i>
                        </span>
                    ...
                    <div className="menu-item">
                      ...
                      >
                        <span className="menu-icon">
                          <i className="ki-solid ki-share"></i>
                        </span>
        ...
        <div className="flex items-center gap-2 lg:gap-3.5">
          ...
          >
            <i className="ki-solid ki-magnifier"></i>
          </button>
          <div
            className="dropdown"
            data-dropdown="true"
          ...
          >
            <button className="dropdown-toggle btn btn-icon btn-icon-lg size-9 rounded-full hover:bg-primary-light hover:text-primary dropdown-open:bg-primary-light dropdown-open:text-primary text-gray-500">
              <i className="ki-solid ki-messages"></i>
            </button>
                      ...
                      <div className="menu" data-menu="true">
                        ...
                        >
                          <button className="menu-toggle btn btn-sm btn-icon btn-light btn-clear">
                            <i className="ki-solid ki-dots-vertical"></i>
                          </button>
                          <div
                          ...
                          >
                            ...
                            >
                              ...
                              <div className="menu-dropdown menu-default w-full max-w-[175px]">
                                <div className="menu-item">
                                  ...
                                  >
                                    <span className="menu-icon">
                                      <i className="ki-solid ki-shield-search"></i>
                                    </span>
                                ...
                                <div className="menu-item">
                                  ...
                                  >
                                    <span className="menu-icon">
                                      <i className="ki-solid ki-filter-edit"></i>
                                    </span>
                                    <span className="menu-title">
                                      Group Settings
                                    </span>
                            ...
                            <div className="menu-item">
                              ...
                              >
                                <span className="menu-icon">
                                  <i className="ki-solid ki-setting-3"></i>
                                </span>
                  ...
                  <div className="flex items-end justify-end gap-3.5 px-5">
                    <div className="flex flex-col gap-1.5">
                      ...
                      <div className="flex items-center justify-end relative">
                        ...
                        <i className="ki-solid ki-double-check text-lg absolute text-success"></i>
                      </div>
                    </div>
                  ...
                  <div className="flex items-end justify-end gap-3.5 px-5">
                    <div className="flex flex-col gap-1.5">
                      ...
                      <div className="flex items-center justify-end relative">
                        ...
                        <i className="ki-solid ki-double-check text-lg absolute text-gray-400"></i>
                      </div>
                    </div>
                    <div className="relative shrink-0">
                      <img
          ...
          >
            <button className="dropdown-toggle btn btn-icon btn-icon-lg relative cursor-pointer size-9 rounded-full hover:bg-primary-light hover:text-primary dropdown-open:bg-primary-light dropdown-open:text-primary text-gray-500">
              <i className="ki-solid ki-notification-on"></i>
            ...
            <div className="dropdown-content light:border-gray-300 w-full max-w-[460px]">
              ...
              >
                ...
                <div className="menu" data-menu="true">
                  ...
                  >
                    <button className="menu-toggle btn btn-sm btn-icon btn-light btn-clear">
                      <i className="ki-solid ki-setting-2"></i>
                    </button>
                    <div
                      className="menu-dropdown menu-default w-full max-w-[175px]"
                      data-menu-dismiss="true"
                    >
                      ...
                      >
                        <div className="menu-link">
                          <span className="menu-icon">
                            <i className="ki-solid ki-notification-status"></i>
                          </span>
                        ...
                        <div className="menu-dropdown menu-default w-full max-w-[175px]">
                          ...
                          <div className="menu-item">
                            ...
                            >
                              <span className="menu-icon">
                                <i className="ki-solid ki-message-notify"></i>
                              </span>
                      ...
                      <div className="menu-item">
                        <a className="menu-link" href="#">
                          <span className="menu-icon">
                            <i className="ki-solid ki-pencil"></i>
                          </span>
                          ...
                          <div className="card shadow-none flex flex-col gap-2.5 p-3.5 rounded-lg bg-light-active">
                            ...
                            <label className="input input-sm">
                              ...
                              <button className="btn btn-icon">
                                <i className="ki-solid ki-picture"></i>
                              </button>
                            </label>
                          </div>
                        </div>
                    ...
                    <div className="flex flex-col gap-5 pt-3 pb-4">
                      ...
                      <div className="flex items-center grow gap-2.5 px-5">
                        <div className="flex items-center justify-center size-8 bg-success-light rounded-full border border-success-clarity">
                          <i className="ki-solid ki-check text-lg text-success"></i>
                        </div>
                        <div className="flex flex-col gap-1">
                      ...
                      <div className="flex grow gap-2.5 px-5">
                        ...
                        <div className="flex flex-col gap-2.5 grow">
                          ...
                          <div className="card shadow-none flex items-center flex-row gap-1.5 px-2.5 py-1.5 rounded-lg bg-light-active">
                            <i className="ki-solid ki-user-tick text-success text-base"></i>
              ...
              <div className="menu-dropdown menu-default light:border-gray-300 w-full max-w-[250px]">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="menu-item">
                    ...
                    >
                      <span className="menu-icon">
                        <i className="ki-solid ki-profile-circle"></i>
                      </span>
                  ...
                  >
                    ...
                    <div className="menu-dropdown menu-default light:border-gray-300 w-full max-w-[220px]">
                      ...
                      <div className="menu-item">
                        ...
                        >
                          <span className="menu-icon">
                            <i className="ki-solid ki-some-files"></i>
                          </span>
                          <span className="menu-title">My Profile</span>
                        </a>
                      </div>
                      <div className="menu-item">
                        <a className="menu-link" href="#">
                          ...
                          >
                            <i className="ki-solid ki-information-2 text-md text-gray-500"></i>
                            <span
                              className="tooltip"
                      ...
                      <div className="menu-item">
                        ...
                        >
                          <span className="menu-icon">
                            <i className="ki-solid ki-medal-star"></i>
                          </span>
                      ...
                      <div className="menu-item">
                        ...
                        >
                          <span className="menu-icon">
                            <i className="ki-solid ki-setting"></i>
                          </span>
                          <span className="menu-title">
                            Members &amp; Roles
                          </span>
                      ...
                      <div className="menu-item">
                        ...
                        >
                          <span className="menu-icon">
                            <i className="ki-solid ki-switch"></i>
                          </span>
                      ...
                      <div className="menu-item">
                        ...
                        >
                          <span className="menu-icon">
                            <i className="ki-solid ki-shield-tick"></i>
                          </span>
                  ...
                  <div className="menu-item">
                    <a className="menu-link" href="https://devs.keenthemes.com">
                      <span className="menu-icon">
                        <i className="ki-solid ki-message-programming"></i>
                      </span>
