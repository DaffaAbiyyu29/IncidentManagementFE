    ...
    return <div className="modal" data-modal="true" id="search_modal">
        <div className="modal-content max-w-[600px] top-[15%]">
            <div className="modal-header py-4 px-5">
                <i className="ki-duotone ki-magnifier text-gray-700 text-xl"></i>
                <input
                ...
                >
                    <i className="ki-duotone ki-cross"></i>
                </button>
            </div>
            <div className="modal-body p-0 pb-5">
                <div className="tabs justify-between px-5 mb-2.5" data-tabs="true">
                    ...
                    <div className="menu -mt-px" data-menu="true">
                        ...
                        >
                            <button className="menu-toggle btn btn-sm btn-icon btn-light btn-clear">
                                <i className="ki-duotone ki-setting-2"></i>
                            </button>
                            <div
                  ...
                  <span className="menu-icon">
                    <i className="ki-duotone ki-document"></i>
                  </span>
                  ...
                  <span className="menu-icon">
                    <i className="ki-duotone ki-notification-status"></i>
                  </span>
                                        <span className="menu-title">Export</span>
                                        <span className="menu-arrow">
                    <i className="ki-duotone ki-right text-3xs"></i>
                  </span>
                                    </div>
                                    <div className="menu-dropdown menu-default w-full max-w-[175px]">
                                        <div className="menu-item">
                                            ...
                                            >
                      <span className="menu-icon">
                        <i className="ki-duotone ki-sms"></i>
                      </span>
                                        ...
                                        <div className="menu-item">
                                            ...
                                            >
                      <span className="menu-icon">
                        <i className="ki-duotone ki-message-notify"></i>
                      </span>
                      ...
                      <span className="menu-icon">
                        <i className="ki-duotone ki-notification-status"></i>
                                ...
                                <div className="menu-item">
                                    <a className="menu-link" href="#">
                  <span className="menu-icon">
                    <i className="ki-duotone ki-pencil"></i>
                  </span>
                                ...
                                <div className="menu-item">
                                    <a className="menu-link" href="#">
                  <span className="menu-icon">
                    <i className="ki-duotone ki-trash"></i>
                  </span>
                            ...
                            <div>
                                ...
                                <div className="menu menu-default p-0 flex-col">
                                    <div className="menu-item">
                                        <a className="menu-link" href="#">
                    <span className="menu-icon">
                      <i className="ki-duotone ki-badge"></i>
                    </span>
                    ...
                    <span className="menu-icon">
                      <i className="ki-duotone ki-setting-2"></i>
                                    ...
                                    <div className="menu-item">
                                        <a className="menu-link" href="#">
                    <span className="menu-icon">
                      <i className="ki-duotone ki-message-programming"></i>
                    </span>
                            ...
                            tyler.hero@gmail.com connections
                                                ...
                                                <div className="flex items-center gap-2.5">
                                                    ...
                                                    <button className="btn btn-icon btn-light btn-clear btn-sm">
                                                        <i className="ki-duotone ki-dots-vertical"></i>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div className="hidden" id="search_modal_settings">
                        <div className="menu menu-default p-0 flex-col">
                            ...
                            <div className="menu-item">
                                <a className="menu-link" href="#">
                <span className="menu-icon">
                  <i className="ki-duotone ki-home-2"></i>
                </span>
                ...
                <span className="menu-icon">
                  <i className="ki-duotone ki-badge"></i>
                            ...
                            <div className="menu-item">
                                <a className="menu-link" href="#">
                <span className="menu-icon">
                  <i className="ki-duotone ki-profile-circle"></i>
                </span>
                ...
                <span className="menu-icon">
                  <i className="ki-duotone ki-message-programming"></i>
                            ...
                            <div className="menu-item">
                                <a className="menu-link" href="#">
                <span className="menu-icon">
                  <i className="ki-duotone ki-user"></i>
                </span>
                            ...
                            <div className="menu-item">
                                <a className="menu-link" href="#">
                <span className="menu-icon">
                  <i className="ki-duotone ki-user-edit"></i>
                </span>
                            ...
                            <div className="menu-item">
                                <a className="menu-link" href="#">
                <span className="menu-icon">
                  <i className="ki-duotone ki-subtitle"></i>
                </span>
                            ...
                            <div className="menu-item">
                                <a className="menu-link" href="#">
                <span className="menu-icon">
                  <i className="ki-duotone ki-setting"></i>
                </span>
